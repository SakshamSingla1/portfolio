...
import { type IExperience } from '../../services/useProfileMasterService';
...
const ExperienceTimeline: React.FC<ExperienceTimelineProps> = ({ 
  ...
  const sortedExperienceByEndDate = [...experiences].sort((a, b) => {
    const endYearA = a.endDate ? parseInt(a.endDate) : 0;
    const endYearB = b.endDate ? parseInt(b.endDate) : 0;
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <div className="relative space-y-12">
        {sortedExperienceByEndDate.map((experience, index) => {
          ...
          return (
            ...
            >
              ...
              <div className="w-12 md:w-2/12 flex justify-left mb-6 md:mb-0">
